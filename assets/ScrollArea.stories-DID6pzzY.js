...
- 스크롤바는 콘텐츠가 영역을 넘어갈 때만 표시됩니다.
    ...
    `})},j={render:()=>({components:{ScrollArea:P},setup(){return{longText:Z}},template:`
...
}`,...j.parameters?.docs?.source}}};const gr=["Playground","Basic","Vertical","Horizontal","Both","List","Autosize","NoScrollbars","DifferentSizes"];export{W as Autosize,D as Basic,O as Both,j as DifferentSizes,I as Horizontal,M as List,Y as NoScrollbars,q as Playground,N as Vertical,gr as __namedExportsOrder,hr as default};
