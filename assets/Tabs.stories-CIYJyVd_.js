...
Mainly so arrow navigation is done accordingly (left & right vs. up & down)`,declarations:[],schema:{kind:"enum",type:"DataOrientation",schema:['"horizontal"','"vertical"']}},{name:"defaultValue",type:"StringOrNumber",description:"The value of the tab that should be active when initially rendered. Use when you do not need to control the state of the tabs",declarations:[],schema:{kind:"enum",type:"StringOrNumber",schema:["string","number"]}},{name:"activationMode",type:'"manual" | "automatic"',description:"Whether a tab is activated automatically (on focus) or manually (on click).",declarations:[],schema:{kind:"enum",type:'"manual" | "automatic"',schema:['"manual"','"automatic"']}},{name:"unmountOnHide",type:"boolean",description:"When `true`, the element will be unmounted on closed state.",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}}],sourceFiles:"/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/tabs/Tabs.vue"};const ye=O(["inline-flex w-fit items-center justify-center border-b-2 border-gray-300"]),T=b({__name:"TabList",props:{class:{},loop:{type:Boolean},asChild:{type:Boolean},as:{}},setup(n){const t=n,o=F(t,"class"),a=c(()=>E(ye(),t.class));return(i,u)=>(g(),C(e(me),_({"data-slot":"tabs-list"},e(o),{class:a.value}),{default:d(()=>[y(i.$slots,"default")]),_:3},16,["class"]))}});T.__docgenInfo={exportName:"default",displayName:"TabList",type:1,props:[{name:"asChild",global:!1,description:`Change the default rendered element for the one passed as a child, merging their props and behavior.

Read our [Composition](https://www.reka-ui.com/docs/guides/composition) guide for more details.`,tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"as",global:!1,description:"The element or component this component should render as. Can be overwritten by `asChild`.",tags:[{name:"defaultValue",text:'"div"'}],required:!1,type:"AsTag | Component",declarations:[],schema:{kind:"enum",type:"AsTag | Component",schema:['"svg"','"input"',{kind:"object",type:"ComponentOptions<any, any, any, ComputedOptions, MethodOptions, any, any, any, string, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>"},{kind:"event",type:'(props: any, ctx: Omit<{ attrs: Data; slots: Readonly<InternalSlots>; emit: (event: string, ...args: any[]) => void; expose: <Exposed extends Record<string, any> = Record<string, any>>(exposed?: Exposed) => void; }, "expose">): any'},{kind:"object",type:"ComponentPublicInstanceConstructor<any, any, any, any, ComputedOptions, MethodOptions>"},'"template"','"a"','"button"','"div"','"form"','"h2"','"h3"','"img"','"label"','"li"','"nav"','"ol"','"p"','"span"','"ul"',{kind:"object",type:"{} & string"}]}},{name:"loop",global:!1,description:"When `true`, keyboard navigation will loop from last tab to first, and vice versa.",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"class",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"},{name:"style",global:!1,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"},{name:"key",global:!1,description:"",tags:[],required:!1,type:"PropertyKey",declarations:[],schema:{kind:"enum",type:"PropertyKey",schema:["string","number","symbol"]}},{name:"ref",global:!1,description:"",tags:[],required:!1,type:"VNodeRef",declarations:[],schema:{kind:"enum",type:"VNodeRef",schema:["string","Ref<any, any>",{kind:"event",type:"(ref: Element | ComponentPublicInstance<{}, {}, {}, {}, {}, {}, {}, {}, false, ComponentOptionsBase<any, any, any, any, any, any, any, any, any, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>, ... 4 more ..., any>, refs: Record<...>): void"}]}},{name:"ref_for",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"ref_key",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"}],events:[],slots:[{name:"default",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}}],exposed:[{name:"asChild",type:"boolean",description:`Change the default rendered element for the one passed as a child, merging their props and behavior.

Read our [Composition](https://www.reka-ui.com/docs/guides/composition) guide for more details.`,declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"as",type:"AsTag | Component",description:"The element or component this component should render as. Can be overwritten by `asChild`.",declarations:[],schema:{kind:"enum",type:"AsTag | Component",schema:['"svg"','"input"',{kind:"object",type:"ComponentOptions<any, any, any, ComputedOptions, MethodOptions, any, any, any, string, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>"},{kind:"event",type:'(props: any, ctx: Omit<{ attrs: Data; slots: Readonly<InternalSlots>; emit: (event: string, ...args: any[]) => void; expose: <Exposed extends Record<string, any> = Record<string, any>>(exposed?: Exposed) => void; }, "expose">): any'},{kind:"object",type:"ComponentPublicInstanceConstructor<any, any, any, any, ComputedOptions, MethodOptions>"},'"template"','"a"','"button"','"div"','"form"','"h2"','"h3"','"img"','"label"','"li"','"nav"','"ol"','"p"','"span"','"ul"',{kind:"object",type:"{} & string"}]}},{name:"loop",type:"boolean",description:"When `true`, keyboard navigation will loop from last tab to first, and vice versa.",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"class",type:"string",description:"",declarations:[],schema:"string"}],sourceFiles:"/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/tabs/TabList.vue"};const he=O(["not-disabled:hover:text-primary text-secondary text-sm font-bold whitespace-nowrap focus-visible:outline-none","relative -mb-[2px] inline-flex h-full items-center justify-center gap-1.5 px-6 py-3","data-[state=active]:border-primary data-[state=active]:text-primary border-b-2 border-transparent transition-[color,box-shadow,border-color]","cursor-pointer disabled:cursor-not-allowed disabled:opacity-50","[&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0"]),f=b({__name:"TabsTrigger",props:{class:{},value:{},disabled:{type:Boolean},asChild:{type:Boolean},as:{}},setup(n){const t=n,o=F(t,"class"),a=c(()=>E(he(),t.class)),i=Z(o);return(u,r)=>(g(),C(e(Ce),_({"data-slot":"tabs-trigger",class:a.value},e(i)),{default:d(()=>[y(u.$slots,"default")]),_:3},16,["class"]))}});f.__docgenInfo={exportName:"default",displayName:"TabsTrigger",type:1,props:[{name:"class",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"},{name:"value",global:!1,description:"A unique value that associates the trigger with a content.",tags:[],required:!0,type:"StringOrNumber",declarations:[],schema:{kind:"enum",type:"StringOrNumber",schema:["string","number"]}},{name:"disabled",global:!1,description:"When `true`, prevents the user from interacting with the tab.",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"asChild",global:!1,description:`Change the default rendered element for the one passed as a child, merging their props and behavior.
...
- **Orientation**: 탭의 방향을 수평(horizontal) 또는 수직(vertical)으로 설정합니다.
        `}}},args:{defaultValue:"account",orientation:"horizontal"},render:n=>({components:{Tabs:h,TabList:T,TabsTrigger:f,TabsContent:v},setup(){return{args:n}},template:`
      <div class="w-[500px]">
        <Tabs v-bind="args">
          <TabList>
    ...
    `})},B={render:()=>({components:{Tabs:h,TabList:T,TabsTrigger:f,TabsContent:v},template:`
      <div class="w-[500px]">
        <Tabs default-value="tab1">
          <TabList>
            <TabsTrigger value="tab1">탭 1</TabsTrigger>
    ...
    `})},D={render:()=>({components:{Tabs:h,TabList:T,TabsTrigger:f,TabsContent:v,User:oe,Settings:se,Bell:ne,FileText:re},template:`
      <div class="w-[600px]">
    ...
    `})},k={render:()=>({components:{Tabs:h,TabList:T,TabsTrigger:f,TabsContent:v},template:`
      <div class="w-[600px]">
    ...
    `})},w={render:()=>({components:{Tabs:h,TabList:T,TabsTrigger:f,TabsContent:v},template:`
      <div class="w-[700px]">
    ...
    `})},A={render:()=>({components:{Tabs:h,TabList:T,TabsTrigger:f,TabsContent:v},template:`
      <div class="w-[500px]">
