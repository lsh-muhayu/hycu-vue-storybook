...
Mainly so arrow navigation is done accordingly (left & right vs. up & down)`,declarations:[],schema:{kind:"enum",type:"DataOrientation",schema:['"vertical"','"horizontal"']}},{name:"modelValue",type:"StringOrNumber",description:"The controlled value of the tab to activate. Can be bind as `v-model`.",declarations:[],schema:{kind:"enum",type:"StringOrNumber",schema:["string","number"]}},{name:"defaultValue",type:"StringOrNumber",description:"The value of the tab that should be active when initially rendered. Use when you do not need to control the state of the tabs",declarations:[],schema:{kind:"enum",type:"StringOrNumber",schema:["string","number"]}},{name:"activationMode",type:'"automatic" | "manual"',description:"Whether a tab is activated automatically (on focus) or manually (on click).",declarations:[],schema:{kind:"enum",type:'"automatic" | "manual"',schema:['"automatic"','"manual"']}},{name:"unmountOnHide",type:"boolean",description:"When `true`, the element will be unmounted on closed state.",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}}],sourceFiles:"/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/tabs/Tabs.vue"};const ye=O(["inline-flex w-fit items-center justify-center border-b-2 border-gray-300"]),T=b({__name:"TabList",props:{class:{},loop:{type:Boolean},asChild:{type:Boolean},as:{}},setup(n){const t=n,o=F(t,"class"),a=c(()=>E(ye(),t.class));return(i,u)=>(g(),C(e(me),_({"data-slot":"tabs-list"},e(o),{class:a.value}),{default:d(()=>[y(i.$slots,"default")]),_:3},16,["class"]))}});T.__docgenInfo={exportName:"default",displayName:"TabList",type:1,props:[{name:"class",global:!0,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"},{name:"asChild",global:!1,description:`Change the default rendered element for the one passed as a child, merging their props and behavior.
