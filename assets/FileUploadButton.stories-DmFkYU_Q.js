import{j as U,d as z,N as b,c as E,o as A,a as B,l as F,w as M,u as y,q as L,F as k,r as d}from"./iframe-CF81DoD3.js";import{_ as S}from"./Button-ByQujeOb.js";import{r as w,u as P}from"./index-Cbg7eOeP.js";import"./preload-helper-PPVm8Dsz.js";const I=U("upload",[["path",{d:"M12 3v12",key:"1x0j5s"}],["path",{d:"m17 8-5-5-5 5",key:"7q97r8"}],["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}]]),j=["accept","multiple","capture"],o=z({inheritAttrs:!1,__name:"FileUploadButton",props:{variant:{default:"outlined"},color:{default:"secondary"},size:{default:"md"},type:{},disabled:{type:Boolean},loading:{type:Boolean},class:{},accept:{},multiple:{},capture:{},onChange:{}},setup(l){const n=b("input"),e=l,t=w(e,"variant","color","size","onChange"),r=P(t),u=()=>{const a=n.value;a&&(a.value="")};return(a,s)=>(A(),E(k,null,[B("input",{ref:"input",type:"file",class:"hidden",accept:e.accept,multiple:e.multiple,capture:e.capture,onChange:s[0]||(s[0]=i=>e.onChange?.(i,{clear:u}))},null,40,j),F(S,L({...a.$attrs,...y(r)},{variant:e.variant,color:e.color,size:e.size,onClick:s[1]||(s[1]=i=>n.value?.click())}),{default:M(()=>[F(y(I),{class:"size-4 shrink-0"}),s[2]||(s[2]=B("span",null,"파일 선택",-1))]),_:1},16,["variant","color","size"])],64))}}),N={title:"Shared/UI/FileUploadButton",component:o,parameters:{layout:"centered",controls:{include:["variant","color","size","disabled","loading","accept","multiple"]},docs:{description:{component:`
### 파일 업로드를 위한 버튼 컴포넌트
