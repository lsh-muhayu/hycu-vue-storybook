import{_ as t}from"./Button-B9gewK8x.js";import{B as s}from"./bell-D2xQDuzT.js";import{b as r}from"./iframe-BBSGBsjB.js";import"./preload-helper-PPVm8Dsz.js";const B=r("circle-pause",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"10",x2:"10",y1:"15",y2:"9",key:"c1nkhi"}],["line",{x1:"14",x2:"14",y1:"15",y2:"9",key:"h65svq"}]]);const m=r("download",[["path",{d:"M12 15V3",key:"m9g1x1"}],["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["path",{d:"m7 10 5 5 5-5",key:"brsn70"}]]);const d=r("log-out",[["path",{d:"m16 17 5-5-5-5",key:"1bji2h"}],["path",{d:"M21 12H9",key:"dn1m92"}],["path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4",key:"1uf3rs"}]]);const v=r("trash-2",[["path",{d:"M10 11v6",key:"nco0om"}],["path",{d:"M14 11v6",key:"outv1u"}],["path",{d:"M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6",key:"miytrc"}],["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2",key:"e791ji"}]]),x={title:"Shared/UI/Button",component:t,parameters:{layout:"centered",docs:{description:{component:'\n### 사용자 액션을 위한 인터랙티브 버튼 컴포넌트\n\n버튼 컴포넌트는 사용자 인터페이스에서 액션을 트리거하는 데 사용됩니다. 다양한 크기, 색상 및 변형을 지원합니다.\n\n## 주요 기능\n\n- **다양한 사이즈**: `xs`, `sm`, `md`, `lg`, `icon-md`, `icon-sm` 여섯 가지 크기 옵션 제공\n- **여러 색상 옵션**: `primary`, `secondary`, `danger`, `success`, `warning`, `deepblue` 색상 지원\n- **세 가지 스타일 변형**: `filled` (채워진), `outlined` (테두리), `text` (텍스트) 스타일\n- **로딩 상태 표시**: 비동기 작업 중 로딩 스피너 자동 표시\n- **아이콘 버튼 지원**: 아이콘과 텍스트를 함께 사용 가능\n- **접근성 지원**: `disabled` 상태 및 `aria-busy` 속성으로 접근성 향상\n- **포커스 관리**: 키보드 포커스 시 시각적 피드백 제공\n\n## 사용 예시\n\n```vue\n<Button color="primary" variant="filled" size="md">\n  버튼 텍스트\n</Button>\n```\n        '}}},tags:["autodocs"],argTypes:{variant:{control:"select",options:["filled","outlined","text"],description:"버튼의 스타일 변형",table:{type:{summary:"'filled' | 'outlined' | 'text'"},defaultValue:{summary:"'filled'"}}},color:{control:"select",options:["primary","secondary","danger","success","warning","deepblue"],description:"버튼의 색상",table:{type:{summary:"'primary' | 'secondary' | 'danger' | 'success' | 'warning' | 'deepblue'"},defaultValue:{summary:"'primary'"}}},size:{control:"select",options:["xs","sm","md","lg","icon-md","icon-sm"],description:"버튼의 크기",table:{type:{summary:"'xs' | 'sm' | 'md' | 'lg' | 'icon-md' | 'icon-sm'"},defaultValue:{summary:"'md'"}}},disabled:{control:"boolean",description:"버튼 비활성화 여부",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},loading:{control:"boolean",description:"로딩 상태 여부. 로딩 중일 때는 자동으로 disabled 상태가 됩니다.",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}}}},n={parameters:{controls:{disable:!1},docs:{description:{story:"\n이 스토리에서는 Button 컴포넌트의 모든 속성을 인터랙티브하게 조정할 수 있습니다.\n오른쪽 컨트롤 패널을 사용하여 variant, color, size, disabled, loading 등의 속성을 변경해보세요.\n\n## 사용 팁\n\n- **Variant**: 버튼의 스타일을 선택합니다. `filled`는 배경이 채워진 스타일, `outlined`는 테두리만 있는 스타일, `text`는 텍스트만 있는 스타일입니다.\n- **Color**: 버튼의 색상을 선택합니다. 각 색상은 의미에 따라 사용하세요 (예: `danger`는 삭제나 위험한 작업에 사용, `warning`은 경고나 주의가 필요한 작업에 사용).\n- **Size**: 버튼의 크기를 조정합니다. `xs`는 매우 작은 버튼, `sm`는 작은 버튼, `md`는 기본 크기, `lg`는 큰 버튼, `icon-md`와 `icon-sm`는 아이콘 전용 버튼입니다.\n- **Loading**: `true`로 설정하면 버튼이 로딩 상태가 되며 자동으로 비활성화됩니다.\n        "}}},args:{variant:"filled",color:"primary",size:"md"},render:c=>({components:{Button:t},setup(){return{args:c}},template:'<Button v-bind="args">Button</Button>'})},o={render:()=>({components:{Button:t},template:`
    ...
    `})},a={render:()=>({components:{Button:t,Bell:s},template:`
      <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-2">
    ...
    `})},e={render:()=>({components:{Button:t,Bell:s},template:`
      <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-2">
    ...
    `})},u={render:()=>({components:{Button:t,LogOut:d,Download:m,CirclePause:B,Trash2:v,Bell:s},template:`
...
}`,...u.parameters?.docs?.source}}};const y=["Playground","Variants","Sizes","States","LoadingStates","WithIcons","Examples"];export{u as Examples,e as LoadingStates,n as Playground,a as Sizes,l as States,o as Variants,i as WithIcons,y as __namedExportsOrder,x as default};
