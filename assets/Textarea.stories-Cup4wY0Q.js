import{d as b,I as T,b as _,J as w,L,N as V,c as y,o as E,m as F,r as D,a,z as t,y as C,t as v,K as n}from"./iframe-CgGu4OOP.js";import{c as k,a as N}from"./cn-CwZzh8fo.js";import{_ as m}from"./Label-D_DAhPK2.js";import{_ as A}from"./Button-DQy1kY9B.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-CP1iLPSM.js";const S=N(["w-full rounded border border-gray-300 bg-white px-3 py-2 text-sm font-normal text-gray-900 transition-all placeholder:text-gray-400","not-read-only:focus:border-primary not-read-only:focus:shadow-[0_0_0_3px_rgba(106,0,40,0.1)] focus-visible:outline-none","disabled:cursor-not-allowed disabled:bg-gray-100 disabled:opacity-70","read-only:bg-gray-50"],{variants:{invalid:{true:"border-danger text-danger not-read-only:focus:border-danger not-read-only:focus:shadow-[0_0_0_3px_rgba(239,68,68,0.1)]"}}}),r=b({__name:"Textarea",props:T({class:{default:""},invalid:{type:Boolean,default:!1}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(s){const u=s,o=_(()=>k(S({invalid:u.invalid}),u.class)),l=w(s,"modelValue");return(f,i)=>L((E(),y("textarea",F(f.$attrs,{"onUpdate:modelValue":i[0]||(i[0]=g=>l.value=g),class:o.value}),null,16)),[[V,l.value]])}});r.__docgenInfo={exportName:"default",displayName:"Textarea",description:"",tags:{},props:[{name:"class",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"invalid",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],sourceFiles:["/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/textarea/Textarea.vue"]};const I={class:"flex flex-col gap-6"},U={class:"flex flex-col gap-4"},M={class:"flex flex-col gap-4 rounded-lg border border-gray-200 p-4"},P={class:"flex flex-col gap-2"},R={class:"text-xs text-gray-500"},q={class:"flex flex-col gap-2"},O={class:"text-xs text-gray-500"},$={class:"flex flex-col gap-2"},z={class:"text-xs text-gray-500"},H={class:"flex gap-2"},h=b({__name:"Controlled.stories",setup(s){const u=D("이것은 초기 설명입니다."),o=D(""),l=D(""),f=()=>{u.value="",o.value="",l.value=""},i=()=>{u.value="이것은 제어 컴포넌트 예시입니다. 부모 컴포넌트가 v-model을 통해 상태를 제어합니다.",o.value="좋은 제품입니다. 사용하기 편리하고 기능이 다양합니다.",l.value=`추가로 개선할 점:
1. 성능 최적화
2. UI 개선
3. 접근성 향상`};return(g,e)=>(E(),y("div",I,[a("div",U,[e[8]||(e[8]=a("div",{class:"flex flex-col gap-2"},[a("h3",{class:"text-sm font-semibold text-gray-700"},"제어 컴포넌트 예시"),a("p",{class:"text-xs text-gray-500"}," 부모 컴포넌트가 v-model을 통해 textarea의 상태를 제어합니다. textarea에 값을 입력하면 상태가 변경되고, 부모에서 상태를 변경하면 textarea가 즉시 반영됩니다. ")],-1)),a("div",M,[a("div",P,[t(m,{required:"",for:"controlled-description",class:"text-sm font-medium text-gray-700"},{default:C(()=>[...e[3]||(e[3]=[n("설명",-1)])]),_:1}),t(r,{id:"controlled-description",modelValue:u.value,"onUpdate:modelValue":e[0]||(e[0]=d=>u.value=d),placeholder:"설명을 입력하세요",rows:3},null,8,["modelValue"]),a("span",R," 현재 값: "+v(u.value||"(비어있음)")+" (초기값: 이것은 초기 설명입니다.) ",1)]),a("div",q,[t(m,{required:"",for:"controlled-feedback",class:"text-sm font-medium text-gray-700"},{default:C(()=>[...e[4]||(e[4]=[n("피드백",-1)])]),_:1}),t(r,{id:"controlled-feedback",modelValue:o.value,"onUpdate:modelValue":e[1]||(e[1]=d=>o.value=d),placeholder:"피드백을 입력하세요",rows:4},null,8,["modelValue"]),a("span",O,"현재 값: "+v(o.value||"(비어있음)"),1)]),a("div",$,[t(m,{for:"controlled-notes",class:"text-sm font-medium text-gray-700"},{default:C(()=>[...e[5]||(e[5]=[n("메모",-1)])]),_:1}),t(r,{id:"controlled-notes",modelValue:l.value,"onUpdate:modelValue":e[2]||(e[2]=d=>l.value=d),placeholder:"메모를 입력하세요",rows:5},null,8,["modelValue"]),a("span",z,"현재 값: "+v(l.value||"(비어있음)"),1)])]),a("div",H,[t(A,{onClick:i},{default:C(()=>[...e[6]||(e[6]=[n(" 값 채우기 ",-1)])]),_:1}),t(A,{color:"secondary",onClick:f},{default:C(()=>[...e[7]||(e[7]=[n(" 초기화 ",-1)])]),_:1})]),e[9]||(e[9]=a("div",{class:"rounded-lg border border-blue-200 bg-blue-50 p-3"},[a("p",{class:"text-xs text-blue-800"},[a("strong",null,"참고:"),n(" 제어 컴포넌트는 부모 컴포넌트가 상태를 소유하고 관리합니다. textarea에 값을 입력하면 v-model을 통해 부모로 전달되고, 부모가 상태를 변경하면 textarea가 즉시 반영됩니다. ")])],-1))])]))}});h.__docgenInfo={exportName:"default",displayName:"Controlled.stories",description:"",tags:{},sourceFiles:["/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/textarea/Controlled.stories.vue"]};const X={title:"Shared/UI/Textarea",component:r,parameters:{layout:"centered",docs:{description:{component:`
### 여러 줄 텍스트 입력 컴포넌트
...
}`,...B.parameters?.docs?.source}}};const Y=["Playground","Basic","States","Controlled"];export{x as Basic,B as Controlled,c as Playground,p as States,Y as __namedExportsOrder,X as default};
