...
controlling animation with Vue animation libraries.`,tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"align",global:!1,description:`The preferred alignment against the trigger.
...
the component. If this is not descriptive enough, or you have
content that cannot be announced, use aria-label as a more
descriptive label.`,declarations:[],schema:"string"}],sourceFiles:"/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/tooltip/TooltipContent.vue"};const Bt={title:"Shared/UI/Tooltip",component:k,parameters:{layout:"centered",docs:{description:{component:`
### 추가 정보를 제공하는 툴팁 컴포넌트
...
툴팁 내부에 다양한 요소를 배치하여 더 풍부한 정보를 제공할 수 있습니다.
        `}}},render:()=>({components:{TooltipRoot:k,TooltipTrigger:_,TooltipContent:R,Button:P,CheckCircleIcon:Ee,AlertCircleIcon:Re,XCircleIcon:_e,InfoIcon:fe,StarIcon:ke},template:`
      <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-2">
...
}`,...N.parameters?.docs?.source}}};const xt=["Playground","Positions","LongText","DelayDuration","WithRichContent"];export{F as DelayDuration,S as LongText,O as Playground,I as Positions,N as WithRichContent,xt as __namedExportsOrder,Bt as default};
