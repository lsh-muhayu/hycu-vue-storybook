...
\`\`\`
    ...
    `})},Q={render:()=>({components:{Dialog:N,DialogContent:A,DialogHeader:$,DialogBody:H,DialogFooter:K,DialogTitle:V,DialogCancelButton:j,DialogConfirmButton:z,DialogClose:I,Button:R},setup(){return{isOpen:D(!1)}},template:`
      <div>
    ...
    `})},J={render:()=>({components:{Dialog:N,DialogContent:A,DialogHeader:$,DialogBody:H,DialogFooter:K,DialogTitle:V,DialogDescription:U,DialogCancelButton:j,DialogConfirmButton:z,Button:R},setup(){const e=D(!1),t=D(!1);return{isOpen:e,loading:t,handleConfirm:async()=>{t.value=!0,await new Promise(a=>setTimeout(a,2e3)),t.value=!1,e.value=!1}}},template:`
      <div>
...
이 예시에서는 \`class="h-[500px]"\`를 사용하여 Content의 높이를 500px로 제한하고 있습니다.
        `}}},render:()=>({components:{Dialog:N,DialogContent:A,DialogHeader:$,DialogBody:H,DialogFooter:K,DialogTitle:V,DialogDescription:U,DialogCancelButton:j,DialogConfirmButton:z,DialogClose:I,Button:R},setup(){return{isOpen:D(!1)}},template:`
      <div>
...
}`,...ee.parameters?.docs?.source}}};const sn=["Default","WithVModel","WithLoading","WithLongContent","WithHorizontalScroll"];export{G as Default,ee as WithHorizontalScroll,J as WithLoading,Z as WithLongContent,Q as WithVModel,sn as __namedExportsOrder,on as default};
