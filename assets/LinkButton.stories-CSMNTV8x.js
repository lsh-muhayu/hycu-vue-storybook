import{b as c,d as L,e as m,f as d,g as p,c as C,o as x,h as f,n as g}from"./iframe-B1Ejz58S.js";import{D as v}from"./download-BknTquBs.js";import"./preload-helper-PPVm8Dsz.js";const y=c("arrow-right",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);const D=c("external-link",[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"M10 14 21 3",key:"gplh6r"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}]]);const h=c("refresh-ccw",[["path",{d:"M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"14sxne"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}],["path",{d:"M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16",key:"1hlbsb"}],["path",{d:"M16 16h5v5",key:"ccwih5"}]]),z=p(d("inline-flex items-center justify-center gap-1 transition-colors outline-none","not-disabled:cursor-pointer not-disabled:hover:underline not-disabled:focus-visible:underline",'disabled:opacity-50 not-[aria-busy="true"]:disabled:cursor-not-allowed',"aria-busy:cursor-progress"),{variants:{color:{primary:"text-primary focus-visible:text-primary-dark hover:text-primary-dark",secondary:"text-secondary hover:text-gray-800 focus-visible:text-gray-800",success:"text-success hover:text-green-800 focus-visible:text-green-800",warning:"text-warning hover:text-yellow-800 focus-visible:text-yellow-800",danger:"text-danger hover:text-red-800 focus-visible:text-red-800",info:"text-info hover:text-blue-800 focus-visible:text-blue-800"},size:{xs:"text-xs",sm:"text-sm"}},defaultVariants:{color:"primary",size:"sm"}}),n=L({__name:"LinkButton",props:{color:{default:"primary"},size:{default:"sm"},class:{default:""}},setup(r){const l=r,k=m(()=>d(z({color:l.color,size:l.size}),l.class));return(B,b)=>(x(),C("button",{class:g(k.value)},[f(B.$slots,"default")],2))}});n.__docgenInfo={exportName:"default",displayName:"LinkButton",description:"",tags:{},props:[{name:"color",required:!1,type:{name:"TSIndexedAccessType"},defaultValue:{func:!1,value:"'primary'"}},{name:"size",required:!1,type:{name:"TSIndexedAccessType"},defaultValue:{func:!1,value:"'sm'"}},{name:"class",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"''"}}],slots:[{name:"default"}],sourceFiles:["/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/link-button/LinkButton.vue"]};const w={title:"Shared/UI/LinkButton",component:n,parameters:{layout:"centered",docs:{description:{component:`
### 링크처럼 보이는 버튼 컴포넌트
...
\`\`\`
    ...
    `})},i={render:()=>({components:{LinkButton:n,ExternalLinkIcon:D,ArrowRightIcon:y,DownloadIcon:v},template:`
      <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-2">
    ...
    `})},u={render:()=>({components:{LinkButton:n,RefreshCcwIcon:h},template:`
...
}`,...a.parameters?.docs?.source}}};const I=["Playground","Colors","Sizes","States","WithIcons","Examples","CustomStyling"];export{o as Colors,a as CustomStyling,u as Examples,t as Playground,s as Sizes,e as States,i as WithIcons,I as __namedExportsOrder,w as default};
