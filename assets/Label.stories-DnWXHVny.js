import{d as C,b as c,c as d,o as i,f as p,D as m,m as f,r as b}from"./iframe-C_9oc38I.js";import{c as x,a as g}from"./cn-CwZzh8fo.js";import"./preload-helper-PPVm8Dsz.js";const D={key:0,class:"text-danger ml-0.5"},B=g("text-sm font-semibold text-gray-800"),u=C({__name:"Label",props:{required:{type:Boolean,default:!1},class:{default:""}},setup(e){const o=e,s=c(()=>x(B(),o.class));return(t,v)=>(i(),d("label",f(t.$attrs,{class:s.value}),[p(t.$slots,"default"),e.required?(i(),d("span",D,"*")):m("",!0)],16))}});u.__docgenInfo={exportName:"default",displayName:"Label",description:"",tags:{},props:[{name:"required",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"class",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"''"}}],slots:[{name:"default"}],sourceFiles:["/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/label/Label.vue"]};const h={title:"Shared/UI/Label",component:u,parameters:{layout:"centered",docs:{description:{component:`
### 폼 요소를 위한 라벨 컴포넌트
...
오른쪽 컨트롤 패널을 사용하여 required, class, for 등의 속성을 변경해보세요.
        `}}},args:{required:!1,class:""},render:e=>({components:{Label:u},setup(){return{args:e}},template:'<Label :required="args.required" :class="args.class">라벨 텍스트</Label>'})},a={render:()=>({components:{Label:u},template:`
    ...
    `})},l={render:()=>({components:{Label:u},template:`
      <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-4">
          <div class="flex flex-col gap-2">
    ...
    `})},n={render:()=>({components:{Label:u},setup(){const e=b({name:"",email:"",phone:""});return{formData:e,handleSubmit:s=>{s.preventDefault(),alert(`제출된 데이터: ${JSON.stringify(e.value,null,2)}`)}}},template:`
      <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-4">
          <div class="flex flex-col gap-2">
...
}`,...n.parameters?.docs?.source}}};const q=["Playground","Basic","Required","WithForm"];export{a as Basic,r as Playground,l as Required,n as WithForm,q as __namedExportsOrder,h as default};
