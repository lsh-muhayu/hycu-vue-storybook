import{d as W,r as R,b as $,e as E,f as O,o as V,w as c,g as p,n as T,h as g,m as q,u as L,i as j,j as e}from"./iframe-CQfUjsSq.js";import{u as I}from"./useForwardPropsEmits-CCM0EFW1.js";import{_ as H}from"./DialogOverlayKit-nvudA3CI.js";import{_ as M,a as F,b as K,c as U,d as z,e as G,f as J,g as Q}from"./DialogConfirmButton-CZu78d-l.js";import{r as X}from"./index-BVeUbUV0.js";import{_ as l}from"./Button-CvIqUMPZ.js";import"./preload-helper-PPVm8Dsz.js";import"./context-Diqh70UU.js";import"./useDirection-DldIr3WL.js";import"./Primitive-BAu_vKek.js";import"./getActiveElement-FUKBWQwh.js";import"./Presence-BscNf9Yc.js";import"./useId-CGK-pjqO.js";import"./Teleport-C6JbDKmc.js";import"./handleAndDispatchCustomEvent-ChOKVcqp.js";import"./ScrollArea-Bef5pPIy.js";const N=W({__name:"AlertDialog",props:{class:{default:""},overlayControl:{},onClose:{},onConfirm:{},onCancel:{}},emits:["update:open"],setup(s,{emit:o}){const t=s,m=o,d=R(!1),u=X(t,"class","onClose","onConfirm","onCancel"),y=I(u,m),i=r=>{r||t.onClose?.()},a=async()=>{if(t.onConfirm){d.value=!0;try{await t.onConfirm(t.overlayControl)}finally{d.value=!1}}else t.overlayControl.close()},S=async()=>{await t.onCancel?.(t.overlayControl)},_=$(()=>E("w-fit max-w-[630px]",t.class));return(r,P)=>(V(),O(H,q(L(y),{loading:d.value,"onUpdate:open":i}),{default:c(()=>[p(M,{"is-close-button":!1,class:T(_.value)},{default:c(()=>[p(F,null,{default:c(()=>[p(K,null,{default:c(()=>[g(r.$slots,"title")]),_:3}),p(U,null,{default:c(()=>[g(r.$slots,"description")]),_:3})]),_:3}),p(z,null,{default:c(()=>[g(r.$slots,"body")]),_:3}),p(G,null,{default:c(()=>[p(J,{onClick:S},{default:c(()=>[g(r.$slots,"cancel")]),_:3}),p(Q,{onClick:a},{default:c(()=>[g(r.$slots,"confirm")]),_:3})]),_:3})]),_:3},8,["class"])]),_:3},16,["loading"]))}});N.__docgenInfo={exportName:"default",displayName:"AlertDialog",type:1,props:[{name:"class",global:!0,description:"DialogContent에 적용할 커스텀 클래스",tags:[],required:!1,type:"string",declarations:[],schema:"string",default:'""'},{name:"key",global:!0,description:"",tags:[],required:!1,type:"PropertyKey",declarations:[],schema:{kind:"enum",type:"PropertyKey",schema:["string","number","symbol"]}},{name:"ref",global:!0,description:"",tags:[],required:!1,type:"VNodeRef",declarations:[],schema:{kind:"enum",type:"VNodeRef",schema:["string","Ref<any, any>",{kind:"event",type:"(ref: Element | ComponentPublicInstance<{}, {}, {}, {}, {}, {}, {}, {}, false, ComponentOptionsBase<any, any, any, any, any, any, any, any, any, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>, ... 4 more ..., any>, refs: Record<...>): void"}]}},{name:"ref_for",global:!0,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"ref_key",global:!0,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"},{name:"style",global:!0,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"}],events:[],slots:[{name:"title",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}},{name:"description",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}},{name:"body",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}},{name:"cancel",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}},{name:"confirm",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}}],exposed:[{name:"$slots",type:"Readonly<InternalSlots> & { title?: (props: {}) => any; } & { description?: (props: {}) => any; } & { body?: (props: {}) => any; } & { cancel?: (props: {}) => any; } & { ...; }",description:"",declarations:[],schema:{kind:"object",type:"Readonly<InternalSlots> & { title?: (props: {}) => any; } & { description?: (props: {}) => any; } & { body?: (props: {}) => any; } & { cancel?: (props: {}) => any; } & { ...; }"}},{name:"class",type:"string",description:"DialogContent에 적용할 커스텀 클래스",declarations:[],schema:"string"}],sourceFiles:"/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/alert-dialog/AlertDialog.vue"};const n=(s,o)=>{const{title:t,description:m,body:d,cancel:u,confirm:y}=s,{class:i,onClose:a,onConfirm:S,onCancel:_,...r}=o??{};j.open(P=>e(N,{...r,class:i,onClose:a,onConfirm:S,onCancel:_,overlayControl:P},{...t&&{title:()=>t},...m&&{description:()=>m},...d&&{body:()=>d},...u&&{cancel:()=>u},...y&&{confirm:()=>y}}))};n.__docgenInfo={exportName:"openAlertDialog",displayName:"openAlertDialog",type:2,props:[{name:"title",global:!1,description:"제목",tags:[],required:!1,type:"SlotContent",declarations:[],schema:{kind:"enum",type:"SlotContent",schema:["string","VNode<RendererNode, RendererElement, { [key: string]: any; }>",{kind:"array",type:"VNode<RendererNode, RendererElement, { [key: string]: any; }>[]"}]}},{name:"description",global:!1,description:"설명",tags:[],required:!1,type:"SlotContent",declarations:[],schema:{kind:"enum",type:"SlotContent",schema:["string","VNode<RendererNode, RendererElement, { [key: string]: any; }>",{kind:"array",type:"VNode<RendererNode, RendererElement, { [key: string]: any; }>[]"}]}},{name:"body",global:!1,description:"본문",tags:[],required:!1,type:"SlotContent",declarations:[],schema:{kind:"enum",type:"SlotContent",schema:["string","VNode<RendererNode, RendererElement, { [key: string]: any; }>",{kind:"array",type:"VNode<RendererNode, RendererElement, { [key: string]: any; }>[]"}]}},{name:"cancel",global:!1,description:"취소 버튼 텍스트",tags:[],required:!1,type:"SlotContent",declarations:[],schema:{kind:"enum",type:"SlotContent",schema:["string","VNode<RendererNode, RendererElement, { [key: string]: any; }>",{kind:"array",type:"VNode<RendererNode, RendererElement, { [key: string]: any; }>[]"}]}},{name:"confirm",global:!1,description:"확인 버튼 텍스트",tags:[],required:!1,type:"SlotContent",declarations:[],schema:{kind:"enum",type:"SlotContent",schema:["string","VNode<RendererNode, RendererElement, { [key: string]: any; }>",{kind:"array",type:"VNode<RendererNode, RendererElement, { [key: string]: any; }>[]"}]}}],events:[],slots:[],exposed:[],sourceFiles:"/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/alert-dialog/openAlertDialog.ts"};const ye={title:"Shared/UI/AlertDialog",component:N,parameters:{layout:"centered",docs:{description:{component:`
### AlertDialog 컴포넌트
...
\`\`\`
        `}}},tags:["autodocs"]},h={name:"기본",render:()=>({components:{Button:l},setup(){return{handleClick:()=>{n({title:"알림",description:"이것은 기본 AlertDialog입니다.",cancel:"취소",confirm:"확인"})}}},template:`
      <Button @click="handleClick">기본 AlertDialog 열기</Button>
    `})},f={name:"본문 내용 포함",render:()=>({components:{Button:l},setup(){return{handleClick:()=>{n({title:"작업 완료",description:"요청하신 작업이 성공적으로 완료되었습니다.",body:e("div",{class:"space-y-2"},[e("p",{class:"text-gray-700"},"처리된 항목:"),e("ul",{class:"list-disc pl-5 text-sm text-gray-600"},[e("li","파일 업로드 완료"),e("li","데이터 검증 완료"),e("li","저장 완료")])]),cancel:"닫기",confirm:"확인"})}}},template:`
      <Button @click="handleClick">본문 내용이 있는 AlertDialog 열기</Button>
    `})},C={name:"핸들러 포함",render:()=>({components:{Button:l},setup(){return{handleClick:()=>{n({title:"설정 저장",description:"변경사항을 저장하시겠습니까?",body:e("p",{class:"text-sm text-gray-600"},"저장하지 않으면 변경사항이 손실됩니다."),cancel:"취소",confirm:"저장"},{onClose:()=>{console.log("AlertDialog가 닫혔습니다")},onCancel:o=>{console.log("취소 버튼 클릭됨"),alert("취소되었습니다"),o.close()},onConfirm:o=>{console.log("확인 버튼 클릭됨"),alert("저장되었습니다!"),o.close()}})}}},template:`
      <Button @click="handleClick">핸들러가 있는 AlertDialog 열기</Button>
    `})},x={name:"비동기 처리",render:()=>({components:{Button:l},setup(){return{handleClick:()=>{n({title:"데이터 전송",description:"서버로 데이터를 전송하시겠습니까?",body:e("div",{class:"text-sm text-gray-600"},[e("p","전송될 데이터: 사용자 정보, 설정 값"),e("p",{class:"mt-2 text-xs text-gray-500"},"※ 확인 버튼을 누르면 로딩 상태를 확인할 수 있습니다.")]),cancel:"취소",confirm:"전송"},{onCancel:o=>{console.log("전송 취소됨"),o.close()},onConfirm:async o=>{console.log("전송 시작..."),await new Promise(t=>setTimeout(t,2e3)),console.log("전송 완료!"),alert("데이터가 성공적으로 전송되었습니다!"),o.close()}})}}},template:`
      <div class="space-y-2">
        <Button @click="handleClick">비동기 처리 AlertDialog 열기</Button>
        <p class="text-xs text-gray-500">※ 확인 버튼을 누르면 2초간 로딩 상태가 표시됩니다.</p>
      </div>
    `})},k={name:"경고 스타일",render:()=>({components:{Button:l},setup(){return{handleClick:()=>{n({title:e("span",{class:"text-yellow-600 flex items-center gap-2"},[e("span","⚠️"),e("span","경고")]),description:"이 작업은 주의가 필요합니다.",body:e("div",{class:"rounded-lg bg-yellow-50 p-3 text-sm text-yellow-800"},[e("p",{class:"font-semibold"},"주의사항:"),e("ul",{class:"mt-2 list-disc pl-5"},[e("li","이 작업은 실행 후 취소할 수 없습니다"),e("li","관련된 모든 데이터에 영향을 줍니다"),e("li","처리 시간이 다소 걸릴 수 있습니다")])]),cancel:"취소",confirm:"계속 진행"})}}},template:`
      <Button @click="handleClick">경고 AlertDialog 열기</Button>
    `})},v={name:"삭제 확인",render:()=>({components:{Button:l},setup(){return{handleClick:()=>{n({title:e("span",{class:"text-red-600 flex items-center gap-2"},[e("span","🗑️"),e("span","삭제 확인")]),description:"이 작업은 되돌릴 수 없습니다.",body:e("div",{class:"space-y-3"},[e("p",{class:"text-gray-700"},"다음 항목이 영구적으로 삭제됩니다:"),e("ul",{class:"list-disc pl-5 text-sm text-gray-600"},[e("li","사용자 프로필 데이터"),e("li","업로드된 모든 파일"),e("li","작성한 게시물 및 댓글"),e("li","활동 기록")]),e("div",{class:"mt-3 rounded-lg bg-red-50 p-3"},[e("p",{class:"text-sm font-semibold text-red-800"},"⚠️ 이 작업은 되돌릴 수 없습니다!")])]),cancel:"취소",confirm:e("span",{class:"font-semibold"},"삭제")},{onCancel:o=>{console.log("삭제 취소됨"),o.close()},onConfirm:async o=>{console.log("삭제 시작..."),await new Promise(t=>setTimeout(t,1500)),console.log("삭제 완료!"),alert("삭제가 완료되었습니다!"),o.close()}})}}},template:`
    ...
    `})},B={name:"커스텀 버튼 텍스트",render:()=>({components:{Button:l},setup(){return{handleClick:()=>{n({title:"로그아웃",description:"정말 로그아웃 하시겠습니까?",body:e("p",{class:"text-sm text-gray-600"},"로그아웃하면 현재 작업 중인 내용이 저장되지 않을 수 있습니다."),cancel:e("span",{class:"text-gray-600"},"아니오, 계속하기"),confirm:e("span",{class:"font-semibold text-red-600"},"예, 로그아웃")})}}},template:`
      <Button @click="handleClick">커스텀 버튼 AlertDialog 열기</Button>
    `})},D={name:"여러 단계",render:()=>({components:{Button:l},setup(){return{handleClick:()=>{n({title:"첫 번째 단계",description:"첫 번째 확인이 필요합니다.",body:e("p",{class:"text-sm text-gray-600"},"확인 버튼을 누르면 다음 단계로 진행됩니다."),cancel:"취소",confirm:"다음"},{onConfirm:o=>{o.close(),setTimeout(()=>{n({title:"두 번째 단계",description:"두 번째 확인이 필요합니다.",body:e("p",{class:"text-sm text-gray-600"},"확인 버튼을 누르면 작업이 완료됩니다."),cancel:"취소",confirm:"완료"},{onConfirm:t=>{alert("모든 단계가 완료되었습니다!"),t.close()}})},300)}})}}},template:`
      <div class="space-y-2">
        <Button @click="handleClick">여러 단계 AlertDialog 열기</Button>
        <p class="text-xs text-gray-500">※ 확인 버튼을 누르면 다음 AlertDialog가 열립니다.</p>
      </div>
    `})},A={name:"긴 내용 (스크롤)",render:()=>({components:{Button:l},setup(){return{handleClick:()=>{n({title:"서비스 이용약관",description:"아래 약관을 확인하시고 동의해주세요.",body:e("div",{class:"space-y-4 text-sm text-gray-700"},[e("section",{},[e("h4",{class:"font-semibold text-gray-900"},"제1조 (목적)"),e("p",{class:"mt-2"},"이 약관은 회사가 제공하는 서비스의 이용과 관련하여 회사와 이용자의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.")]),e("section",{class:"mt-4"},[e("h4",{class:"font-semibold text-gray-900"},"제2조 (정의)"),e("p",{class:"mt-2"},'1. "서비스"란 회사가 제공하는 모든 서비스를 의미합니다.'),e("p",{class:"mt-1"},'2. "이용자"란 본 약관에 따라 회사가 제공하는 서비스를 받는 회원 및 비회원을 말합니다.'),e("p",{class:"mt-1"},'3. "회원"이란 회사에 개인정보를 제공하여 회원등록을 한 자로서, 회사의 서비스를 계속적으로 이용할 수 있는 자를 말합니다.')]),e("section",{class:"mt-4"},[e("h4",{class:"font-semibold text-gray-900"},"제3조 (약관의 게시와 개정)"),e("p",{class:"mt-2"},"1. 회사는 본 약관의 내용을 이용자가 쉽게 알 수 있도록 서비스 초기 화면에 게시합니다."),e("p",{class:"mt-1"},"2. 회사는 필요한 경우 관련 법령을 위배하지 않는 범위에서 본 약관을 개정할 수 있습니다."),e("p",{class:"mt-1"},"3. 회사가 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 제1항의 방식에 따라 그 개정약관의 적용일자 7일 전부터 적용일자 전일까지 공지합니다.")]),e("section",{class:"mt-4"},[e("h4",{class:"font-semibold text-gray-900"},"제4조 (서비스의 제공 및 변경)"),e("p",{class:"mt-2"},"1. 회사는 다음과 같은 서비스를 제공합니다:"),e("ul",{class:"mt-2 list-disc pl-5"},[e("li","정보 제공 서비스"),e("li","커뮤니티 서비스"),e("li","전자상거래 서비스"),e("li","기타 회사가 정하는 서비스")]),e("p",{class:"mt-2"},"2. 회사는 서비스의 내용을 변경할 경우에는 변경사유 및 내용을 명시하여 현행 서비스의 공지사항을 통해 게시합니다.")]),e("section",{class:"mt-4"},[e("h4",{class:"font-semibold text-gray-900"},"제5조 (서비스의 중단)"),e("p",{class:"mt-2"},"1. 회사는 컴퓨터 등 정보통신설비의 보수점검, 교체 및 고장, 통신의 두절 등의 사유가 발생한 경우에는 서비스의 제공을 일시적으로 중단할 수 있습니다."),e("p",{class:"mt-1"},"2. 회사는 제1항의 사유로 서비스의 제공이 일시적으로 중단됨으로 인하여 이용자 또는 제3자가 입은 손해에 대하여 배상합니다. 단, 회사에 고의 또는 과실이 없음을 입증하는 경우에는 그러하지 아니합니다.")]),e("section",{class:"mt-4"},[e("h4",{class:"font-semibold text-gray-900"},"제6조 (회원가입)"),e("p",{class:"mt-2"},"1. 이용자는 회사가 정한 가입 양식에 따라 회원정보를 기입한 후 본 약관에 동의한다는 의사표시를 함으로서 회원가입을 신청합니다."),e("p",{class:"mt-1"},"2. 회사는 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음 각 호에 해당하지 않는 한 회원으로 등록합니다.")])]),cancel:"취소",confirm:"동의"},{class:"h-[500px]"})}}},template:`
      <div class="space-y-2">
        <Button @click="handleClick">긴 내용 AlertDialog 열기</Button>
        <p class="text-xs text-gray-500">※ 본문이 길어서 스크롤이 생깁니다.</p>
      </div>
    `})},w={name:"모든 예시",render:()=>({components:{Button:l},setup(){return{openBasic:()=>{n({title:"알림",description:"이것은 기본 AlertDialog입니다.",cancel:"취소",confirm:"확인"})},openWithBody:()=>{n({title:"작업 완료",description:"요청하신 작업이 성공적으로 완료되었습니다.",body:e("div",{class:"space-y-2"},[e("p",{class:"text-gray-700"},"처리된 항목:"),e("ul",{class:"list-disc pl-5 text-sm text-gray-600"},[e("li","파일 업로드 완료"),e("li","데이터 검증 완료"),e("li","저장 완료")])]),cancel:"닫기",confirm:"확인"},{class:"h-[500px]"})},openWithAsync:()=>{n({title:"데이터 전송",description:"서버로 데이터를 전송하시겠습니까?",cancel:"취소",confirm:"전송"},{onConfirm:async i=>{await new Promise(a=>setTimeout(a,2e3)),alert("전송 완료!"),i.close()}})},openWarning:()=>{n({title:e("span",{class:"text-yellow-600 flex items-center gap-2"},[e("span","⚠️"),e("span","경고")]),description:"이 작업은 주의가 필요합니다.",cancel:"취소",confirm:"계속 진행"})},openDelete:()=>{n({title:e("span",{class:"text-red-600 flex items-center gap-2"},[e("span","🗑️"),e("span","삭제 확인")]),description:"이 작업은 되돌릴 수 없습니다.",cancel:"취소",confirm:"삭제"},{onConfirm:async i=>{await new Promise(a=>setTimeout(a,1500)),alert("삭제 완료!"),i.close()}})},openSuccess:()=>{n({title:e("span",{class:"text-green-600 flex items-center gap-2"},[e("span","✅"),e("span","성공")]),description:"작업이 성공적으로 완료되었습니다!",cancel:"닫기",confirm:"확인"})},openLongContent:()=>{n({title:"긴 내용",description:"본문이 길어서 스크롤이 생깁니다.",body:e("div",{class:"space-y-2"},[...Array.from({length:20},(i,a)=>e("p",{class:"text-sm text-gray-700"},`${a+1}. 긴 내용의 예시입니다. 스크롤을 확인하세요.`))]),cancel:"취소",confirm:"확인"},{class:"h-[500px]"})}}},template:`
...
} as unknown as Story`,...h.parameters?.docs?.source}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  name: '본문 내용 포함',
  render: () => ({
    components: {
      Button
...
} as unknown as Story`,...f.parameters?.docs?.source}}};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  name: '핸들러 포함',
  render: () => ({
    components: {
      Button
...
} as unknown as Story`,...C.parameters?.docs?.source}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  name: '비동기 처리',
  render: () => ({
    components: {
      Button
...
} as unknown as Story`,...x.parameters?.docs?.source}}};k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  name: '경고 스타일',
  render: () => ({
    components: {
      Button
...
} as unknown as Story`,...A.parameters?.docs?.source}}};w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  name: '모든 예시',
  render: () => ({
    components: {
      Button
...
} as unknown as Story`,...w.parameters?.docs?.source}}};const ge=["Default","WithBody","WithHandlers","WithAsyncHandler","WarningStyle","DeleteConfirmation","SuccessMessage","CustomButtonText","MultiStep","WithLongContent","AllExamples"];export{w as AllExamples,B as CustomButtonText,h as Default,v as DeleteConfirmation,D as MultiStep,b as SuccessMessage,k as WarningStyle,x as WithAsyncHandler,f as WithBody,C as WithHandlers,A as WithLongContent,ge as __namedExportsOrder,ye as default};
