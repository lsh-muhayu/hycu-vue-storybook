import{d as k,A as L,p as w,o as O,q as S,h as F,z as I,u as a,e as q,f as $,r as D}from"./iframe-DHSQivn_.js";import{i as P,_ as t,a as m,b as i,c as l,d as x,e as r,f as s,g,h as d,j as c}from"./DialogConfirmButton-B_4skwKC.js";import{u as R}from"./useForwardProps-Z4p9H_Pr.js";import{u as E,P as j}from"./Primitive-C5jjprS8.js";import{u as z}from"./VisuallyHidden-Bo7m81M1.js";import{b as M,_ as v}from"./Button-e-9aavaB.js";import{r as V}from"./index-DmLYEr8G.js";import{_ as W}from"./Label-BBRkEBr0.js";import{_ as A}from"./Input-kV9lNVg1.js";import{_ as N}from"./Textarea-CYhX1BOd.js";import{_ as Z}from"./Checkbox-CU-mPt3Z.js";import{_ as G,a as K,b as U,c as J}from"./SelectItem-C-MswVWD.js";import"./preload-helper-PPVm8Dsz.js";import"./useForwardPropsEmits-DNRIisSY.js";import"./context-AEd3KiTi.js";import"./useDirection-DPW7wIBQ.js";import"./Collection-Cggd5FgI.js";import"./PopperContent-iVcjZavm.js";import"./ScrollArea-GSq4bT8e.js";import"./nullish-CHIgUVhi.js";import"./VisuallyHiddenInput-m-OZQWxy.js";import"./check-D4i7Nvp_.js";import"./ScrollAreaAutoSize-DI4KVI1D.js";var Q=k({__name:"DialogTrigger",props:{asChild:{type:Boolean,required:!1},as:{type:null,required:!1,default:"button"}},setup(e){const o=e,n=P(),{forwardRef:p,currentElement:T}=E();return n.contentId||=z(void 0,"reka-dialog-content"),L(()=>{n.triggerElement.value=T.value}),(u,H)=>(O(),w(a(j),I(o,{ref:a(p),type:u.as==="button"?"button":void 0,"aria-haspopup":"dialog","aria-expanded":a(n).open.value||!1,"aria-controls":a(n).open.value?a(n).contentId:void 0,"data-state":a(n).open.value?"open":"closed",onClick:a(n).onOpenToggle}),{default:S(()=>[F(u.$slots,"default")]),_:3},16,["type","aria-expanded","aria-controls","data-state","onClick"]))}}),X=Q;const _=k({__name:"DialogTrigger",props:{class:{},asChild:{type:Boolean},as:{},variant:{default:"filled"},color:{default:"primary"},size:{default:"md"}},setup(e){const o=e,n=V(o,"variant","color","size"),p=R(n),T=q(()=>$(M({variant:o.variant,color:o.color,size:o.size}),o.class));return(u,H)=>(O(),w(a(X),I(a(p),{class:T.value}),{default:S(()=>[F(u.$slots,"default")]),_:3},16,["class"]))}});_.__docgenInfo={exportName:"default",displayName:"DialogTrigger",type:1,props:[{name:"variant",global:!1,description:"",tags:[],required:!1,type:'"text" | "filled" | "outlined"',declarations:[],schema:{kind:"enum",type:'"text" | "filled" | "outlined"',schema:['"text"','"filled"','"outlined"']},default:'"filled"'},{name:"size",global:!1,description:"",tags:[],required:!1,type:'"xs" | "sm" | "md" | "lg" | "icon-md" | "icon-sm"',declarations:[],schema:{kind:"enum",type:'"xs" | "sm" | "md" | "lg" | "icon-md" | "icon-sm"',schema:['"xs"','"sm"','"md"','"lg"','"icon-md"','"icon-sm"']},default:'"md"'},{name:"color",global:!1,description:"",tags:[],required:!1,type:'"success" | "primary" | "secondary" | "warning" | "danger" | "deepblue"',declarations:[],schema:{kind:"enum",type:'"success" | "primary" | "secondary" | "warning" | "danger" | "deepblue"',schema:['"success"','"primary"','"secondary"','"warning"','"danger"','"deepblue"']},default:'"primary"'},{name:"class",global:!0,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"},{name:"key",global:!0,description:"",tags:[],required:!1,type:"PropertyKey",declarations:[],schema:{kind:"enum",type:"PropertyKey",schema:["string","number","symbol"]}},{name:"ref",global:!0,description:"",tags:[],required:!1,type:"VNodeRef",declarations:[],schema:{kind:"enum",type:"VNodeRef",schema:["string","Ref<any, any>",{kind:"event",type:"(ref: Element | ComponentPublicInstance<{}, {}, {}, {}, {}, {}, {}, {}, false, ComponentOptionsBase<any, any, any, any, any, any, any, any, any, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>, ... 4 more ..., any>, refs: Record<...>): void"}]}},{name:"ref_for",global:!0,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"ref_key",global:!0,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"},{name:"style",global:!0,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"},{name:"asChild",global:!1,description:`Change the default rendered element for the one passed as a child, merging their props and behavior.

Read our [Composition](https://www.reka-ui.com/docs/guides/composition) guide for more details.`,tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"as",global:!1,description:"The element or component this component should render as. Can be overwritten by `asChild`.",tags:[{name:"defaultValue",text:'"div"'}],required:!1,type:"AsTag | Component",declarations:[],schema:{kind:"enum",type:"AsTag | Component",schema:['"svg"','"input"',{kind:"object",type:"ComponentOptions<any, any, any, ComputedOptions, MethodOptions, any, any, any, string, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>"},{kind:"event",type:'(props: any, ctx: Omit<{ attrs: Data; slots: Readonly<InternalSlots>; emit: (event: string, ...args: any[]) => void; expose: <Exposed extends Record<string, any> = Record<string, any>>(exposed?: Exposed) => void; }, "expose">): any'},{kind:"object",type:"ComponentPublicInstanceConstructor<any, any, any, any, ComputedOptions, MethodOptions>"},'"template"','"a"','"button"','"div"','"form"','"h2"','"h3"','"img"','"label"','"li"','"nav"','"ol"','"p"','"span"','"ul"',{kind:"object",type:"{} & string"}]}}],events:[],slots:[{name:"default",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}}],exposed:[{name:"variant",type:'"text" | "filled" | "outlined"',description:"",declarations:[],schema:{kind:"enum",type:'"text" | "filled" | "outlined"',schema:['"text"','"filled"','"outlined"']}},{name:"size",type:'"xs" | "sm" | "md" | "lg" | "icon-md" | "icon-sm"',description:"",declarations:[],schema:{kind:"enum",type:'"xs" | "sm" | "md" | "lg" | "icon-md" | "icon-sm"',schema:['"xs"','"sm"','"md"','"lg"','"icon-md"','"icon-sm"']}},{name:"color",type:'"success" | "primary" | "secondary" | "warning" | "danger" | "deepblue"',description:"",declarations:[],schema:{kind:"enum",type:'"success" | "primary" | "secondary" | "warning" | "danger" | "deepblue"',schema:['"success"','"primary"','"secondary"','"warning"','"danger"','"deepblue"']}},{name:"class",type:"string",description:"",declarations:[],schema:"string"},{name:"asChild",type:"boolean",description:`Change the default rendered element for the one passed as a child, merging their props and behavior.

Read our [Composition](https://www.reka-ui.com/docs/guides/composition) guide for more details.`,declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"as",type:"AsTag | Component",description:"The element or component this component should render as. Can be overwritten by `asChild`.",declarations:[],schema:{kind:"enum",type:"AsTag | Component",schema:['"svg"','"input"',{kind:"object",type:"ComponentOptions<any, any, any, ComputedOptions, MethodOptions, any, any, any, string, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>"},{kind:"event",type:'(props: any, ctx: Omit<{ attrs: Data; slots: Readonly<InternalSlots>; emit: (event: string, ...args: any[]) => void; expose: <Exposed extends Record<string, any> = Record<string, any>>(exposed?: Exposed) => void; }, "expose">): any'},{kind:"object",type:"ComponentPublicInstanceConstructor<any, any, any, any, ComputedOptions, MethodOptions>"},'"template"','"a"','"button"','"div"','"form"','"h2"','"h3"','"img"','"label"','"li"','"nav"','"ol"','"p"','"span"','"ul"',{kind:"object",type:"{} & string"}]}}],sourceFiles:"/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/dialog/DialogTrigger.vue"};const xe={title:"Shared/UI/Dialog",component:t,parameters:{layout:"centered",docs:{description:{component:`
### 다이얼로그 컴포넌트
...
<\/script>
\`\`\`
        `}}},tags:["autodocs"],argTypes:{loading:{control:"boolean",description:"Dialog의 로딩 상태",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},dismissMode:{control:"select",options:["none","dismiss"],description:"Dialog의 닫기 동작 모드",table:{type:{summary:"'none' | 'dismiss'"},defaultValue:{summary:"'none'"}}}}},f={render:e=>({components:{Dialog:t,DialogTrigger:_,DialogContent:c,DialogHeader:d,DialogBody:g,DialogFooter:s,DialogTitle:r,DialogDescription:x,DialogCancelButton:l,DialogConfirmButton:i,DialogClose:m},setup(){return{args:e}},template:`
      <Dialog>
        <DialogTrigger>다이얼로그 열기</DialogTrigger>
        <DialogContent>
          <DialogHeader>
    ...
    `})},y={render:()=>({components:{Dialog:t,DialogContent:c,DialogHeader:d,DialogBody:g,DialogFooter:s,DialogTitle:r,DialogCancelButton:l,DialogConfirmButton:i,DialogClose:m,Button:v},setup(){return{isOpen:D(!1)}},template:`
      <div>
...
이 예시에서는 \`class="h-[500px]"\`를 사용하여 Content의 높이를 500px로 제한하고 있습니다.
        `}}},render:()=>({components:{Dialog:t,DialogContent:c,DialogHeader:d,DialogBody:g,DialogFooter:s,DialogTitle:r,DialogDescription:x,DialogCancelButton:l,DialogConfirmButton:i,DialogClose:m,Button:v},setup(){return{isOpen:D(!1)}},template:`
      <div>
...
이 예시에서는 \`class="w-[400px]"\`를 사용하여 Content의 너비를 400px로 제한하고, 넓은 테이블을 포함하여 가로 스크롤이 발생하도록 했습니다.
    ...
    `})},B={render:()=>({components:{Dialog:t,DialogTrigger:_,DialogContent:c,DialogHeader:d,DialogBody:g,DialogFooter:s,DialogTitle:r,DialogCancelButton:l,DialogConfirmButton:i,DialogClose:m,Label:W,Input:A,Textarea:N,Checkbox:Z,Select:J,SelectTrigger:U,SelectContent:K,SelectItem:G},template:`
      <Dialog>
...
}`,...B.parameters?.docs?.source}}};const ve=["Default","WithVModel","WithLoading","WithLongContent","WithHorizontalScroll","ThesisGuidancePlanForm"];export{f as Default,B as ThesisGuidancePlanForm,h as WithHorizontalScroll,C as WithLoading,b as WithLongContent,y as WithVModel,ve as __namedExportsOrder,xe as default};
