import{d as C,c as o,i as B,o as P,w as b,p as z,e as _,u as i,F as q,z as w,q as M,t as E,r as a}from"./iframe-DDiegOnq.js";import{_ as $,a as V,b as D,c as F}from"./PaginationPrevious-BZvVO9xA.js";import"./preload-helper-PPVm8Dsz.js";const t=C({__name:"PaginationBar",props:{pageNo:{},pageSize:{}},emits:["page-change"],setup(e,{emit:s}){const n=e,k=s,f=o(()=>Math.max(n.pageSize,1)),p=o(()=>Math.floor((n.pageNo-1)/10)*10+1),N=o(()=>Math.min(p.value+9,f.value)),S=o(()=>Math.max(0,N.value-p.value+1)),y=h=>{h!==n.pageNo&&k("page-change",h)};return(h,r)=>(P(),B(i(F),null,{default:b(()=>[z(i($),{disabled:e.pageNo===1,onClick:r[0]||(r[0]=g=>y(Math.max(p.value-1,1)))},null,8,["disabled"]),(P(!0),_(q,null,w(S.value,g=>(P(),B(i(V),{key:g,"is-current":e.pageNo===g+p.value-1,onClick:R=>y(g+p.value-1)},{default:b(()=>[M(E(g+p.value-1),1)]),_:2},1032,["is-current","onClick"]))),128)),z(i(D),{disabled:e.pageNo===f.value,onClick:r[1]||(r[1]=g=>y(Math.min(N.value+1,f.value)))},null,8,["disabled"])]),_:1}))}});t.__docgenInfo={exportName:"default",displayName:"PaginationBar",type:1,props:[{name:"pageNo",global:!1,description:"현재 페이지 번호",tags:[],required:!0,type:"number",declarations:[],schema:"number"},{name:"pageSize",global:!1,description:"총 페이지 수",tags:[],required:!0,type:"number",declarations:[],schema:"number"},{name:"key",global:!1,description:"",tags:[],required:!1,type:"PropertyKey",declarations:[],schema:{kind:"enum",type:"PropertyKey",schema:["string","number","symbol"]}},{name:"ref",global:!1,description:"",tags:[],required:!1,type:"VNodeRef",declarations:[],schema:{kind:"enum",type:"VNodeRef",schema:["string","Ref<any, any>",{kind:"event",type:"(ref: Element | ComponentPublicInstance<{}, {}, {}, {}, {}, {}, {}, {}, false, ComponentOptionsBase<any, any, any, any, any, any, any, any, any, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>, ... 4 more ..., any>, refs: Record<...>): void"}]}},{name:"ref_for",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"ref_key",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"},{name:"class",global:!1,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"},{name:"style",global:!1,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"}],events:[{name:"page-change",description:"",tags:[],type:"[page: number]",signature:'(event: "page-change", page: number): void',declarations:[],schema:["number"]}],slots:[],exposed:[{name:"pageNo",type:"number",description:"현재 페이지 번호",declarations:[],schema:"number"},{name:"pageSize",type:"number",description:"총 페이지 수",declarations:[],schema:"number"}],sourceFiles:"/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/pagination-bar/PaginationBar.vue"};const O={title:"Shared/UI/PaginationBar",component:t,parameters:{layout:"centered",docs:{description:{component:`
### 페이지네이션 바 컴포넌트
...
\`\`\`
        `}}},tags:["autodocs"],argTypes:{pageNo:{control:{type:"number",min:1},description:"현재 페이지 번호",table:{type:{summary:"number"},defaultValue:{summary:"1"}}},pageSize:{control:{type:"number",min:1},description:"총 페이지 수",table:{type:{summary:"number"},defaultValue:{summary:"1"}}}}},c={parameters:{docs:{description:{story:`
...
- **2000페이지**: 많은 페이지를 가진 페이지네이션
        `}}},render:()=>({components:{PaginationBar:t},setup(){const e=a(1),s=a(1),n=a(1);return{page1:e,page2:s,page3:n}},template:`
...
페이지가 적을 때의 동작입니다. 총 3페이지만 있는 경우입니다.
        `}}},render:()=>({components:{PaginationBar:t},setup(){return{pageNo:a(1)}},template:`
...
이전/다음 버튼을 클릭하면 10개 단위로 그룹이 변경됩니다.
        `}}},render:()=>({components:{PaginationBar:t},setup(){return{pageNo:a(15)}},template:`
      <div class="flex flex-col gap-4">
        <div class="text-center text-sm text-gray-600">
          현재 페이지: {{ pageNo }} / 25
        </div>
...
첫 페이지, 중간 페이지, 마지막 페이지에서 시작하는 예시입니다.
        `}}},render:()=>({components:{PaginationBar:t},setup(){const e=a(1),s=a(15),n=a(50);return{page1:e,page2:s,page3:n}},template:`
      <div class="flex flex-col gap-8">
        <div class="flex flex-col gap-2">
          <div class="text-center text-sm text-gray-600">
...
- 21페이지 (세 번째 그룹이 1개만 있는 경우)
        `}}},render:()=>({components:{PaginationBar:t},setup(){const e=a(1),s=a(11),n=a(21);return{page1:e,page2:s,page3:n}},template:`
      <div class="flex flex-col gap-8">
        <div class="flex flex-col gap-2">
          <div class="text-center text-sm text-gray-600">
...
}`,...v.parameters?.docs?.source}}};const A=["Examples","FewPages","TenPages","MultipleGroups","LargeDataset","StartingAtDifferentPages","EdgeCases"];export{v as EdgeCases,c as Examples,l as FewPages,x as LargeDataset,m as MultipleGroups,u as StartingAtDifferentPages,d as TenPages,A as __namedExportsOrder,O as default};
