import{f as e,e as s,b as l,a,c as b,_ as T,g as R,d as x}from"./TableCenterRow-B6T-A5uS.js";import"./iframe-D0gFUUnQ.js";import"./preload-helper-PPVm8Dsz.js";import"./useForwardProps-sc5pykr_.js";import"./ScrollAreaAutoSize-D4aXj4DV.js";import"./Primitive-xtv3u-0j.js";import"./index-00AB-4Ml.js";const k={title:"Shared/UI/Table",component:e,parameters:{layout:"padded",docs:{description:{component:`
### 테이블 컴포넌트
...
\`\`\`
        `}}},tags:["autodocs"],argTypes:{showVertical:{control:"boolean",description:"수직 스크롤바 표시 여부",table:{type:{summary:"boolean"},defaultValue:{summary:"true"}}},showHorizontal:{control:"boolean",description:"수평 스크롤바 표시 여부",table:{type:{summary:"boolean"},defaultValue:{summary:"true"}}}}},w=[{id:1,name:"홍길동",email:"hong@example.com",role:"관리자",status:"활성"},{id:2,name:"김철수",email:"kim@example.com",role:"사용자",status:"활성"},{id:3,name:"이영희",email:"lee@example.com",role:"사용자",status:"비활성"},{id:4,name:"박민수",email:"park@example.com",role:"관리자",status:"활성"},{id:5,name:"정수진",email:"jung@example.com",role:"사용자",status:"활성"}],o={render:()=>({components:{Table:e,TableHeader:T,TableBody:b,TableRow:a,TableHead:l,TableCell:s},setup(){return{sampleUsers:w}},template:`
...
로딩, 에러, 빈 데이터 등의 피드백을 표시하는 데 유용합니다.
    ...
    `})},i={render:()=>({components:{Table:e,TableHeader:T,TableBody:b,TableRow:a,TableHead:l,TableCell:s},setup(){return{sampleUsers:w}},template:`
      <div class="w-full max-w-4xl">
...
테이블이 컨테이너 너비를 초과하면 수평 스크롤바가 자동으로 표시됩니다.
        `}}},render:()=>({components:{Table:e,TableHeader:T,TableBody:b,TableRow:a,TableHead:l,TableCell:s},setup(){return{sampleUsers:w}},template:`
      <div class="w-full max-w-4xl">
...
많은 열과 긴 텍스트를 포함하여 실제 사용 시나리오를 시뮬레이션합니다.
    ...
    `})},u={render:p=>({components:{Table:e,TableHeader:T,TableBody:b,TableRow:a,TableHead:l,TableCell:s},setup(){return{users:Array.from({length:20}).map((n,r)=>({id:r,name:`사용자 ${r+1}`,email:`user${r+1}@example.com`,role:r%3===0?"관리자":"사용자",status:r%2===0?"활성":"비활성"})),args:p}},template:`
      <div class="h-96 w-full max-w-4xl">
...
}`,...u.parameters?.docs?.source}}};const $=["Basic","WithFooter","Scrollable","EmptyState","LoadingState","CustomStyles","WideTable","HorizontalScroll","Playground"];export{o as Basic,i as CustomStyles,m as EmptyState,C as HorizontalScroll,H as LoadingState,u as Playground,t as Scrollable,c as WideTable,d as WithFooter,$ as __namedExportsOrder,k as default};
