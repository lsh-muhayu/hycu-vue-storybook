...
the component. If this is not descriptive enough, or you have
content that cannot be announced, use aria-label as a more
descriptive label.`,declarations:[],schema:"string"}],sourceFiles:"/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/tooltip/TooltipContent.vue"};const vt={title:"Shared/UI/Tooltip",component:k,parameters:{layout:"centered",docs:{description:{component:`
### 추가 정보를 제공하는 툴팁 컴포넌트
...
}`,...N.parameters?.docs?.source}}};const bt=["Playground","Positions","LongText","DelayDuration","WithRichContent"];export{F as DelayDuration,S as LongText,O as Playground,I as Positions,N as WithRichContent,bt as __namedExportsOrder,vt as default};
