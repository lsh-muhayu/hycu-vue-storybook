import{d as y,I as E,b as w,J as _,L as V,M as F,c as h,m as k,o as A,r as i,a as u,z as p,t as C,y as b,K as D}from"./iframe-any6goSE.js";import{c as S,a as N}from"./cn-CwZzh8fo.js";import{_ as I}from"./Label-TFZ0OAi5.js";import{_ as g}from"./Button-i47IVbAI.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-CUOokE9o.js";const U=["invalid"],M=N(["h-10 rounded border border-gray-300 bg-white px-3 py-2 text-sm font-normal text-gray-900 transition-all placeholder:text-gray-400","not-read-only:focus:border-primary not-read-only:focus:shadow-[0_0_0_3px_rgba(106,0,40,0.1)] focus-visible:outline-none","disabled:cursor-not-allowed disabled:bg-gray-100 disabled:opacity-70","read-only:bg-gray-50"],{variants:{invalid:{true:"border-danger text-danger not-read-only:focus:border-danger not-read-only:focus:shadow-[0_0_0_3px_rgba(239,68,68,0.1)]"}}}),l=y({__name:"Input",props:E({class:{default:""},invalid:{type:Boolean,default:!1}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(d){const a=d,n=w(()=>S(M({invalid:a.invalid}),a.class)),t=_(d,"modelValue");return(o,r)=>V((A(),h("input",k(o.$attrs,{"onUpdate:modelValue":r[0]||(r[0]=B=>t.value=B),class:n.value,invalid:d.invalid}),null,16,U)),[[F,t.value]])}});l.__docgenInfo={exportName:"default",displayName:"Input",description:"",tags:{},props:[{name:"class",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"invalid",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],sourceFiles:["/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/input/Input.vue"]};const P={class:"flex flex-col gap-6"},T={class:"flex flex-col gap-4"},R={class:"flex flex-col gap-4 rounded-lg border border-gray-200 p-4"},$={class:"flex flex-col gap-2"},O={class:"text-xs text-gray-500"},q={class:"flex flex-col gap-2"},z={class:"text-xs text-gray-500"},H={class:"flex flex-col gap-2"},J={class:"text-xs text-gray-500"},K={class:"flex flex-col gap-2"},j={class:"text-xs text-gray-500"},G={class:"flex gap-2"},L=y({__name:"Controlled.stories",setup(d){const a=i("홍길동"),n=i(""),t=i(""),o=i("010-1234-5678"),r=()=>{a.value="",n.value="",t.value="",o.value=""},B=()=>{a.value="홍길동",n.value="hong@example.com",t.value="password123",o.value="010-1234-5678"};return(Q,e)=>(A(),h("div",P,[u("div",T,[e[10]||(e[10]=u("div",{class:"flex flex-col gap-2"},[u("h3",{class:"text-sm font-semibold text-gray-700"},"제어 컴포넌트 예시"),u("p",{class:"text-xs text-gray-500"}," 부모 컴포넌트가 v-model을 통해 입력 필드의 상태를 제어합니다. 입력 필드에 값을 입력하면 상태가 변경되고, 부모에서 상태를 변경하면 입력 필드가 즉시 반영됩니다. ")],-1)),u("div",R,[u("div",$,[e[4]||(e[4]=u("label",{for:"controlled-name",class:"text-sm font-medium text-gray-700"},"이름",-1)),p(l,{id:"controlled-name",modelValue:a.value,"onUpdate:modelValue":e[0]||(e[0]=s=>a.value=s),type:"text",placeholder:"이름을 입력하세요"},null,8,["modelValue"]),u("span",O," 현재 값: "+C(a.value||"(비어있음)")+" (초기값: 홍길동) ",1)]),u("div",q,[e[5]||(e[5]=u("label",{for:"controlled-email",class:"text-sm font-medium text-gray-700"},"이메일",-1)),p(l,{id:"controlled-email",modelValue:n.value,"onUpdate:modelValue":e[1]||(e[1]=s=>n.value=s),type:"email",placeholder:"example@email.com"},null,8,["modelValue"]),u("span",z,"현재 값: "+C(n.value||"(비어있음)"),1)]),u("div",H,[e[6]||(e[6]=u("label",{for:"controlled-password",class:"text-sm font-medium text-gray-700"},"비밀번호",-1)),p(l,{id:"controlled-password",modelValue:t.value,"onUpdate:modelValue":e[2]||(e[2]=s=>t.value=s),type:"password",placeholder:"비밀번호를 입력하세요"},null,8,["modelValue"]),u("span",J,"현재 값: "+C(t.value||"(비어있음)"),1)]),u("div",K,[e[7]||(e[7]=u("label",{for:"controlled-phone",class:"text-sm font-medium text-gray-700"},"전화번호",-1)),p(l,{id:"controlled-phone",modelValue:o.value,"onUpdate:modelValue":e[3]||(e[3]=s=>o.value=s),type:"tel",placeholder:"010-1234-5678"},null,8,["modelValue"]),u("span",j," 현재 값: "+C(o.value||"(비어있음)")+" (초기값: 010-1234-5678) ",1)])]),u("div",G,[p(g,{onClick:B},{default:b(()=>[...e[8]||(e[8]=[D(" 값 채우기 ",-1)])]),_:1}),p(g,{color:"secondary",onClick:r},{default:b(()=>[...e[9]||(e[9]=[D(" 초기화 ",-1)])]),_:1})]),e[11]||(e[11]=u("div",{class:"rounded-lg border border-blue-200 bg-blue-50 p-3"},[u("p",{class:"text-xs text-blue-800"},[u("strong",null,"참고:"),D(" 제어 컴포넌트는 부모 컴포넌트가 상태를 소유하고 관리합니다. 입력 필드에 값을 입력하면 v-model을 통해 부모로 전달되고, 부모가 상태를 변경하면 입력 필드가 즉시 반영됩니다. ")])],-1))])]))}});L.__docgenInfo={exportName:"default",displayName:"Controlled.stories",description:"",tags:{},sourceFiles:["/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/input/Controlled.stories.vue"]};const le={title:"Shared/UI/Input",component:l,parameters:{layout:"centered",docs:{description:{component:'\n### 입력 필드 컴포넌트\n\nInput 컴포넌트는 폼에서 텍스트 입력을 받기 위한 컴포넌트입니다.\n표준 HTML input 요소의 모든 속성을 지원하며, 다양한 상태와 타입을 지원합니다.\n\n## 주요 기능\n\n- **다양한 타입 지원**: `text`, `email`, `password`, `number`, `tel`, `url` 등 모든 input type 지원\n- **상태 관리**: `disabled`, `readOnly` 상태 지원\n- **유효성 검사**: `invalid` prop을 통해 유효하지 않은 입력을 시각적으로 표시\n- **플레이스홀더**: `placeholder`를 통한 사용자 가이드 제공\n- **커스터마이징**: `class`를 통해 스타일 커스터마이징 가능\n\n## 사용 예시\n\n```vue\n<Input type="email" placeholder="example@email.com" />\n<Input type="text" placeholder="이름을 입력하세요" />\n<Input type="password" disabled />\n<Input type="email" placeholder="example@email.com" :invalid="true" />\n```\n        '}}},tags:["autodocs"]},c={parameters:{controls:{disable:!1},docs:{description:{story:`
...
- **Invalid**: \`true\`로 설정하면 유효하지 않은 입력임을 나타내는 빨간색 테두리와 텍스트가 표시됩니다.
    ...
    `})},x={render:()=>({components:{Input:l,Label:I},template:`
      <div class="flex w-80 flex-col gap-4">
        <div class="flex flex-col gap-2">
...
}`,...v.parameters?.docs?.source}}};const ae=["Playground","Basic","Types","States","Controlled"];export{m as Basic,v as Controlled,c as Playground,x as States,f as Types,ae as __namedExportsOrder,le as default};
