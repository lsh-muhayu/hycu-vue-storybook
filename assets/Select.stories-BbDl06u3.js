import{r as v}from"./iframe-BaIWcTIt.js";import{c as e,_ as t,a as l,b as n}from"./SelectItem-AgxVuvoG.js";import{_ as g}from"./Label-CTyLDyjM.js";import"./preload-helper-PPVm8Dsz.js";import"./useForwardPropsEmits-BSkMgtc_.js";import"./index-CtPZgfZt.js";import"./Primitive-Db2cVf6b.js";import"./useId-BBZen8er.js";import"./useTypeahead-BHMPUD87.js";import"./getActiveElement-FUKBWQwh.js";import"./Collection-Fx8AFe8D.js";import"./usePrimitiveElement-e2NGEje1.js";import"./PopperContent-W1z7gCiY.js";import"./Presence-6GtGehS2.js";import"./Teleport-BpWLVRWE.js";import"./nullish-CHIgUVhi.js";import"./handleAndDispatchCustomEvent-ChOKVcqp.js";import"./ScrollArea-CFjyeU3b.js";import"./useDirection-BJ_Nsi6n.js";import"./context-Cww20ms9.js";import"./ScrollAreaAutoSize-CVuQ9qw8.js";import"./ohash.D__AXeF1-C-E83dC9.js";import"./useFormControl-o2B4o1Zc.js";import"./VisuallyHidden-DrUMS5t_.js";import"./useFocusGuards-C2GnesFT.js";const M={title:"Shared/UI/Select",component:e,parameters:{layout:"centered",controls:{include:["disabled","placeholder","invalid","readOnly","size"]},docs:{description:{component:`
### 선택 드롭다운 컴포넌트
...
<\/script>
\`\`\`
        `}}},tags:["autodocs"],argTypes:{disabled:{control:"boolean",description:"Select 비활성화 여부",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},placeholder:{control:"text",description:"선택 전에 표시할 플레이스홀더 텍스트 (SelectTrigger에 전달)",table:{type:{summary:"string"}}},invalid:{control:"boolean",description:"유효하지 않은 입력 여부 (빨간색 테두리 및 텍스트 표시, SelectTrigger에 전달)",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},readOnly:{control:"boolean",description:"읽기 전용 여부 (회색 배경 표시, SelectTrigger에 전달)",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},size:{control:"select",options:["md","sm"],description:"SelectTrigger의 크기",table:{type:{summary:"'md' | 'sm'"},defaultValue:{summary:"'md'"}}}}},c={render:x=>({components:{Select:e,SelectTrigger:n,SelectContent:l,SelectItem:t},setup(){return{args:x}},template:`
      <div class="w-80">
...
- **Size**: Trigger의 크기를 조절합니다. \`md\`는 h-10 text-sm, \`sm\`은 h-8 text-xs입니다.
        `}}},args:{disabled:!1,placeholder:"옵션을 선택하세요",invalid:!1,readOnly:!1,size:"md"}},a={render:()=>({components:{Select:e,SelectTrigger:n,SelectContent:l,SelectItem:t},template:`
    ...
    `})},o={render:()=>({components:{Select:e,SelectTrigger:n,SelectContent:l,SelectItem:t,Label:g},template:`
      <div class="flex w-80 flex-col gap-4">
        <div class="flex flex-col gap-2">
    ...
    `})},i={render:()=>({components:{Select:e,SelectTrigger:n,SelectContent:l,SelectItem:t,Label:g},template:`
      <div class="flex w-80 flex-col gap-4">
        <div class="flex flex-col gap-2">
    ...
    `})},r={render:()=>({components:{Select:e,SelectTrigger:n,SelectContent:l,SelectItem:t,Label:g},template:`
      <div class="flex w-80 flex-col gap-4">
        <div class="flex flex-col gap-2">
...
- 사용자 경험이 향상됩니다.
        `}}},render:()=>({components:{Select:e,SelectTrigger:n,SelectContent:l,SelectItem:t,Label:g},template:`
    ...
    `})},p={render:()=>({components:{Select:e,SelectTrigger:n,SelectContent:l,SelectItem:t},setup(){return{value:v("option1")}},template:`
      <div class="flex w-80 flex-col gap-4">
        <div class="flex flex-col gap-2">
...
}`,...p.parameters?.docs?.source}}};const E=["Playground","Basic","WithLabel","WithDefaultValue","Sizes","States","ItemStates","MaxHeight","AutoSize","Controlled"];export{d as AutoSize,a as Basic,p as Controlled,S as ItemStates,m as MaxHeight,c as Playground,i as Sizes,r as States,s as WithDefaultValue,o as WithLabel,E as __namedExportsOrder,M as default};
