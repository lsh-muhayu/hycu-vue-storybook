...
툴팁 내부에 다양한 요소를 배치하여 더 풍부한 정보를 제공할 수 있습니다.
        `}}},render:()=>({components:{TooltipRoot:k,TooltipTrigger:_,TooltipContent:R,Button:P,CheckCircleIcon:_e,AlertCircleIcon:Re,XCircleIcon:ke,InfoIcon:ce,StarIcon:Ae},template:`
      <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-2">
