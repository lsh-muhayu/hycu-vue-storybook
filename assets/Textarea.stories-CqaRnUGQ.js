import{_ as l}from"./Textarea-BmumrvGS.js";import{_ as m}from"./Label-BIQDAzWS.js";import{d as g,r as x,e as A,o as h,g as a,p as u,w as C,q as t,t as B}from"./iframe-B318oBrw.js";import{_ as D}from"./Button-BH-Bc1oR.js";import"./index-Bng0LbBV.js";import"./index-D8ASTvak.js";import"./preload-helper-PPVm8Dsz.js";const E={class:"flex flex-col gap-6"},T={class:"flex flex-col gap-4"},_={class:"flex flex-col gap-4 rounded-lg border border-gray-200 p-4"},w={class:"flex flex-col gap-2"},k={class:"text-xs text-gray-500"},L={class:"flex flex-col gap-2"},V={class:"text-xs text-gray-500"},F={class:"flex flex-col gap-2"},q={class:"text-xs text-gray-500"},R={class:"flex gap-2"},v=g({__name:"Controlled.stories",setup(f){const r=x("이것은 초기 설명입니다."),o=x(""),n=x(""),y=()=>{r.value="",o.value="",n.value=""},b=()=>{r.value="이것은 제어 컴포넌트 예시입니다. 부모 컴포넌트가 v-model을 통해 상태를 제어합니다.",o.value="좋은 제품입니다. 사용하기 편리하고 기능이 다양합니다.",n.value=`추가로 개선할 점:
1. 성능 최적화
2. UI 개선
