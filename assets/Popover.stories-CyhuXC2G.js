...
If provided, it will replace the default anchor element.`,declarations:[],schema:{kind:"enum",type:"ReferenceElement",schema:[{kind:"object",type:"Element"},{kind:"object",type:"VirtualElement"}]}},{name:"forceMount",type:"boolean",description:`Used to force mounting when more control is needed. Useful when
controlling animation with Vue animation libraries.`,declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}}],sourceFiles:"/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/popover/PopoverContent.vue"};const ae=v({inheritAttrs:!1,__name:"PopoverAnchor",props:{reference:{},asChild:{type:Boolean},as:{}},setup(n){const o=N(n);return(t,i)=>(g(),m(e(Fe),D(w(e(o))),{default:d(()=>[f(t.$slots,"default")]),_:3},16))}});ae.__docgenInfo={exportName:"default",displayName:"PopoverAnchor",type:1,props:[{name:"asChild",global:!1,description:`Change the default rendered element for the one passed as a child, merging their props and behavior.
...
If not provided will use the current component as anchor.`,declarations:[],schema:{kind:"enum",type:"ReferenceElement",schema:[{kind:"object",type:"Element"},{kind:"object",type:"VirtualElement"}]}}],sourceFiles:"/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/popover/PopoverAnchor.vue"};const re=v({inheritAttrs:!1,__name:"Popover",setup(n){return(a,o)=>(g(),m(h,null,{default:d(()=>[f(a.$slots,"default")]),_:3}))}});re.__docgenInfo={exportName:"default",displayName:"Popover",type:1,props:[{name:"class",global:!1,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"},{name:"style",global:!1,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"},{name:"key",global:!1,description:"",tags:[],required:!1,type:"PropertyKey",declarations:[],schema:{kind:"enum",type:"PropertyKey",schema:["string","number","symbol"]}},{name:"ref",global:!1,description:"",tags:[],required:!1,type:"VNodeRef",declarations:[],schema:{kind:"enum",type:"VNodeRef",schema:["string","Ref<any, any>",{kind:"event",type:"(ref: Element | ComponentPublicInstance<{}, {}, {}, {}, {}, {}, {}, {}, false, ComponentOptionsBase<any, any, any, any, any, any, any, any, any, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>, ... 4 more ..., any>, refs: Record<...>): void"}]}},{name:"ref_for",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"ref_key",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"}],events:[],slots:[{name:"default",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}}],exposed:[],sourceFiles:"/github-runner/_work/ck-tms-hycu/ck-tms-hycu/frontend/src/shared/ui/popover/Popover.vue"};const Do={title:"Shared/UI/Popover",component:re,parameters:{layout:"centered",docs:{description:{component:`
### 팝오버 컴포넌트
...
}`,...j.parameters?.docs?.source}}};const wo=["Basic","WithRichContent","Positions","WithAnchor","InDialog","InDialogWithLongContent","Controlled","WithForm","MultiplePopovers"];export{_ as Basic,F as Controlled,S as InDialog,A as InDialogWithLongContent,j as MultiplePopovers,O as Positions,E as WithAnchor,I as WithForm,q as WithRichContent,wo as __namedExportsOrder,Do as default};
